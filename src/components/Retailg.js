  ...
  console.log(info)
    ...
    return(
        <div className="retbg">
            ...
            <Box sx={{display:"flex" , flexWrap:"wrap", justifyContent:"space-between",  margin:"0 auto" , flexDirection:{sm:"column", xs:"column",md:"row"}}}  >
                { 
                    info.map((redata)=>{
                    ...
                    const {id, name , img} = redata
                        ...
                        return(
                            <Box  key={id}   >
                                <Box sx={{textAlign:"center"}}> <img src={img} alt="not loaded" /> </Box>
