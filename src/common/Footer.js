    ...
    <Box sx={{paddingBottom:"20px"}}>
      <Grid container spacing={2} sx={{ display: "flex", justifyContent: "center" }}>
        ...
        <Grid item xs={12} sm={6} sx={{ display: "flex", justifyContent: "space-evenly" }}>
          <Box sx={{ marginTop: { xs: "15px", sm: "0" }, paddingRight: { sm: "20px" } }}>
            <p><a href='#!' className='foot-text'>ABOUT US</a></p>
            <p><a href='#!' className='foot-text'>GOVERNANCE</a></p>
            <p><a href='#!' className='foot-text'>NEWS & UPDATES</a></p>
          </Box>
          <Box sx={{ marginTop: { xs: "15px", sm: "0" }, paddingRight: { sm: "30px" } }}>
            <p><a href='#!' className='foot-text'>FAQ’S</a></p>
            <p><a href='#!' className='foot-text'>PRIVACY POLICY</a></p>
            <p><a href='#!' className='foot-text'>DISCLAIMER</a></p>
          </Box>
          <Box sx={{ display: { xs: "flex", sm: "none" }, gap: "20px", alignItems: "center", paddingRight: { sm: "30px" } }}>
            <p><img src={face} className='foot-icon' alt="Facebook" /></p>
            <p><img src={twit} className='foot-icon' alt="Twitter" /></p>
            <p><img src={insta} className='foot-icon' alt="Instagram" /></p>
          </Box>
          <Box sx={{ display: { xs: "flex", sm: "none", md:"flex" }, alignItems: "center", paddingLeft: { sm: "50px" } }}>
            <img src={upar} height="40px" alt="Upar" />
          </Box>
        </Grid>
      </Grid>
    </Box>
